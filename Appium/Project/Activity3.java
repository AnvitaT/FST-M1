...
public class Activity3 {
    ...
    public void setUp() throws MalformedURLException {
        ...
        options.noReset();
        // Server Address
        URL serverURL = new URL("http://localhost:4723/wd/hub");        // Driver Initialization
        driver = new AndroidDriver(serverURL, options);
        wait = new WebDriverWait(driver, Duration.ofSeconds(10));        // Open the page in Chrome
        driver.get("https://www.training-support.net/selenium");
    }
    // Test method
    @Test
    public void addTasks() throws InterruptedException { String tasks[]=new String[3];
        tasks[0]="Add tasks to list";
        tasks[1]="Get number of tasks";
        tasks[2]="Clear the list";        String UiScrollable = "UiScrollable(UiSelector().scrollable(true))";
        ...
        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.Button[@text='Add Task']")));        for(int i=0;i<3;i++) {
