...
import java.time.Duration;public class Activity1 {
    // Driver Declaration
    AndroidDriver driver;    // Set up method
    @BeforeClass
    public void setUp() throws MalformedURLException {
        ...
        options.noReset();        // Server Address
    ...
    public void addTasks() throws InterruptedException {
        ...
        tasks[2]="Complete the second Activity Google Keep";        // perform task addition
        By title = AppiumBy.id("add_task_title");        for ( int i=0;i<3;i++) {
