...
public class Activity6 {
    public static void main(String[] args) {
        ...
        // Find the login details and click
       driver.findElement(By.cssSelector(".ld-login")).click();
       driver.findElement(By.id("user_login")).sendKeys("root");
       driver.findElement(By.id("user_pass")).sendKeys("pa$$w0rd");
       driver.findElement(By.id("wp-submit")).click();

       // Verify you logged in and Assertion for the same
       WebElement usercheck = driver.findElement(By.cssSelector("#wp-admin-bar-my-account > a:nth-child(1)"));
       usercheck.getText();

        System.out.println("login-user: " + usercheck.getText());
        Assert.assertEquals(usercheck.getText(), "Howdy, root");
